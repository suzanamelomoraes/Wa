  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        { id: 4, name: 'Jess', email: 'jess@devacademy.com', mobile: 99999999, password: 'great', balance: 3, address: '12 Morgan Street, Newmarket, 0600', latitude: 1234, longitude: 4321, image: '/images/avatar01.png' }
      ])
    })
}
